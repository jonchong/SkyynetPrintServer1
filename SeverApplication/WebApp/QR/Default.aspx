...
<body>
    ...
    <div id="fb-root"></div>
        ...
        <h3 style="font-weight: 600; font-size: xx-large;">&nbsp; SkyyNet QR COde&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </h3>
    ...
    <form id="form2" runat="server">
        ...
        <p><fb:login-button autologoutlink="true" data-size="xlarge" perms="email,user_birthday,status_update,publish_stream"></fb:login-button>
                    ...
                    <td>
                        <img alt="" class="auto-style6" src="green2.gif" style="width: 199px; height: 120px" /></td>
                </tr>
                <tr>
        ...
        <div id="name"></div>
                ...
                <tr>
                    <td class="auto-style2" style="vertical-align: top">
                        <br />
        <asp:Button ID="Button1" runat="server" Text="QR Generator" OnClientClick="JavaScriptFunction()" onclick="Button1_Click" Font-Bold="True" Font-Size="Large" Height="44px" Width="133px" />
                    </td>
                    <td class="auto-style5" style="font-size: larger; vertical-align: top;">Step 3 - If you are this person Click!</td>
                    <td>
                        <asp:Image ID="Image1" runat="server" Height="78px" ImageUrl="~/QR/images.jpg" Width="126px" />
                    </td>
                </tr>
            </table>
        </p>
